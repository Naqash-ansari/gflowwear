    ...
    <nav className="bg-[#1f2937] border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">GFlowWear</span>
        </Link>
        <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
          <button type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer bg-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
          <ul className="flex flex-col  font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:border-gray-700">
            <li>
              <Link href="/" alt='llll' className={`text-white text-white rounded-md px-5 py-2 text-sm font-medium ${isActive('/')} `}>Home</Link>
            </li>
            <li>
              <Link href="/layout/shop" className={`text-white text-white rounded-md px-5 py-2 text-sm font-medium ${isActive('/layout/shop')} `}>Shop</Link>
            </li>
            {/* <li>
              <Link href="/layout/services" className={`text-white text-white rounded-md px-5 py-2 text-sm font-medium ${isActive('/')} `}>Services</Link>
            </li> */}
            <li>
              <Link href="/layout/product" className={`text-white text-white rounded-md px-5 py-2 text-sm font-medium ${isActive('/layout/product')} `}>Product</Link>
            </li>
            <li>
              <Link href="/layout/contact" className={`text-white text-white rounded-md px-5 py-2 text-sm font-medium ${isActive('/layout/contact')} `}>Contact</Link>
            </li>
          </ul>
        </div>
      </div>
